...
<link 
 ...
 <style type="text/css"> 
   .enroll{ 
   background-image: url("images/addstudent.png"); 
   ...
   .view{ 
      background-image: url("images/ViewStudents.png"); 
   background-size: cover; 
   background-repeat: no-repeat; 
   } 
 </style>  
...
<body> 
  ...
  <img src="images/Sinhgadlogo.jpeg" width="100px" height="50px">  
  <div class="pt-2"> 
  <a href="#enroll"> 
  ...
  <div class="container  h-100"> 
    <div class="row justify-content-center h-100 w-75"> 
      <div class="col-12 col-lg-9 col-xl-7"> 
        <div class="card shadow-2-strong card-registration mt-0" style="border-radius: 15px;border: 5px solid red"> 
...
/> 
 ...
 <section class="view" style="height:530px;border: 5px solid red" id="view"> 
